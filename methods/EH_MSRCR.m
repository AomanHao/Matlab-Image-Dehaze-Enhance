...
[MSR_r,SSR_r,Rr] = EH_MSR_rgbChannel(Ir,Gauss_1,Gauss_2,Gauss_3);

[MSR_g,SSR_g,Gg] = EH_MSR_rgbChannel(Ig,Gauss_1,Gauss_2,Gauss_3);

[MSR_b,SSR_b,Bb] = EH_MSR_rgbChannel(Ib,Gauss_1,Gauss_2,Gauss_3);
...
switch conf.MSR_mode
    ...
    case 'MSRCR'
        %计算CR
        MSRCR_r = EH_MSRCR_rgb(Ir,Ig,Ib,Rr,conf);
        MSRCR_g = EH_MSRCR_rgb(Ir,Ig,Ib,Gg,conf);
        MSRCR_b = EH_MSRCR_rgb(Ir,Ig,Ib,Bb,conf);
